      ...
      <Tabs
        ...
        items={[
          ...
          },
          {
            ...
            key: '2',
            children: <MultipleRowSlick status={true} arrFilm={arrFilm} />,
          },
        ]}
      />
              ...
              >
                ...
                <div className="flex flex-col justify-between p-4 ">
                  <h2 className="film-name-card-mobile font-semibold mb-2">
                    {itemFilm.tenPhim.length > 22
                      ? itemFilm.tenPhim.toUpperCase().slice(0, 22) + '...'
                      : itemFilm.tenPhim.toUpperCase()}
                  </h2>
                  <button
                    onClick={() => navigate(`detail/${itemFilm.maPhim}`)}
