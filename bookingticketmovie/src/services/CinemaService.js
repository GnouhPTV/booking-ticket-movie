...
export const LayThongTinLichChieuHeThongRap = () =>
  http.get(`/QuanLyRap/LayThongTinLichChieuHeThongRap?maNhom=${GROUPID}`);

export const LayThongTinLichChieu = (maPhim) =>
  http.get(`/QuanLyRap/LayThongTinLichChieuPhim?MaPhim=${maPhim}`);

export const layThongTinHeThongRap = () =>
  http.get(`/QuanLyRap/LayThongTinHeThongRap`);
