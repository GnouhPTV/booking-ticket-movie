    ...
    if (!token) {
      ...
      const callApiThongTinNguoiDungCheckAdmin = async () => {
        try {
          ...
          if (
            apiNguoiDung.data.content.maLoaiNguoiDung !== token.maLoaiNguoiDung
          ) {
            navigate('/notfound');
          } else {
            setIsLoading(false);
                ...
                },
                {
                  ...
                  children: [
                    ...
                    },
                    {
                      ...
                      label: <NavLink to="film/addnew">Thêm phim</NavLink>,
                    },
                  ],
                },
                {
                  ...
                  label: <NavLink to="showtime">Quản lý lịch chiếu</NavLink>,
                },
              ]}
            />
          </Sider>
