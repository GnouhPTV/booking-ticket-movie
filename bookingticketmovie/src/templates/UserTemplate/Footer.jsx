        ...
        <div className="lg:w-1/4">
          ...
          >
            <svg
              ...
              fill="currentColor"
              viewBox="0 0 32 32"
              className="w-10 h-10 sm:w-12 sm:h-12 lg:w-16 lg:h-16  text-orange-500"
            >
            ...
            <span className="text-xl font-medium text-orange-500 sm:text-2xl ">
              Movie Capstone
            </span>
          </NavLink>
        </div>
        <div className="grid grid-cols-1 text-sm gap-x-3 gap-y-8 lg:w-3/4 sm:grid-cols-2 lg:grid-cols-4">
          <div className="hidden sm:block space-y-3">
            ...
            <ul className="space-y-3">
              <li>
                <a href="#!" className="text-zinc-300  title-widget-item">
                  <FontAwesomeIcon icon={faAnglesRight} /> VỀ CHÚNG TÔI
                </a>
              </li>
              <li>
                <a href="#!" className="text-zinc-300 title-widget-item">
                  <FontAwesomeIcon icon={faAnglesRight} /> THỎA THUẬN SỬ DỤNG
                </a>
              </li>
              <li>
                <a href="#!" className="text-zinc-300 title-widget-item">
                  <FontAwesomeIcon icon={faAnglesRight} /> QUY CHẾ BẢO MẬT
                </a>
              </li>
              <li>
                <a href="#!" className="text-zinc-300 title-widget-item">
                  <FontAwesomeIcon icon={faAnglesRight} /> CHÍNH SÁCH BẢO MẬT
                </a>
              </li>
            </ul>
          </div>
          <div className="hidden sm:block space-y-3">
            ...
            <ul className="space-y-3">
              <li>
                <a href="#!" className="text-zinc-300 title-widget-item">
                  <FontAwesomeIcon icon={faAnglesRight} /> GÓP Ý
                </a>
              </li>
              <li>
                <a href="#!" className="text-zinc-300 title-widget-item">
                  <FontAwesomeIcon icon={faAnglesRight} /> SALE & SERVICE
                </a>
              </li>
              <li>
                <a href="#!" className="text-zinc-300 title-widget-item">
                  <FontAwesomeIcon icon={faAnglesRight} /> RẠP / GIÁ VÉ
                </a>
              </li>
              <li>
                <a href="#!" className="text-zinc-300 title-widget-item">
                  <FontAwesomeIcon icon={faAnglesRight} /> TUYỂN DỤNG
                </a>
              </li>
            </ul>
          </div>
          <div className="space-y-3">
            ...
            <ul className="space-y-3">
              <li>
                ...
                >
                  <FontAwesomeIcon
                    className="w-8 h-8 md:w-11 md:h-11 mr-3"
