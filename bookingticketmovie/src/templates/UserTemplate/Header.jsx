          ...
          {isLogin ? (
            ...
            <>
              <div className="text-gray-500 hover:text-red-600 flex items-center mb-4">
                ...
                <NavLink
                  to="login"
                  className="text-base font-semibold text-gray-500 hover:text-red-600"
                >
                  Đăng Nhập
                </NavLink>
              </div>
      ...
      <header className="bg-gray-400 font-sans leading-normal tracking-normal">
        ...
        >
          ...
          <div className="block lg:hidden">
            ...
            >
              <svg
                className="fill-current h-4 w-4 text-orange-500"
                viewBox="0 0 20 20"
                xmlns="http://www.w3.org/2000/svg"
              >
                <title>Menu</title>
            ...
            <div className="flex text-gray-500">
              {isLogin ? (
                ...
                <>
                  <NavLink
                    to="login"
                    className=" mr-2 text-gray-500 hover:text-red-600 text-sm font-semibold border-orange-500 border-2 py-2 px-3 rounded-lg"
                  >
                    Đăng Nhập
                  </NavLink>
                  <NavLink
                    to="register"
                    className="text-gray-500 hover:text-red-600 text-sm font-semibold border-orange-500 border-2 py-2 px-3 rounded-lg"
                  >
                    Đăng Ký
                  </NavLink>
                </>
